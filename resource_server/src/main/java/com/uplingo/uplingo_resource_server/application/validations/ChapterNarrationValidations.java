...
public final class ChapterNarrationValidations {

  public static ResponseDTO<Void> validateCreateDTO(ChapterNarrationCreateDTO dto) {
    if (dto == null) {
      return ResponseDTO.error(HttpStatus.BAD_REQUEST, "Chapter narration must not be null");
    }
